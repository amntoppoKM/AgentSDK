...
public class KmGroupInfoTask extends AsyncTask<Object, Object, Channel> {
    Context context;
    ...
    public KmGroupInfoTask(Context context, String clientGroupId, GroupMemberListener groupMemberListener) {
    ...
    public KmGroupInfoTask(Context context, Integer channelKey, GroupMemberListener groupMemberListener) {
        this.context = context;
        this.channelService = ChannelService.getInstance(context);
